...
def plotDrifts_EBgradB(patches): 
    ...
    axs[0].add_collection(LineCollection(bdry, linewidths=0.2, color='black', zorder=0))
    ...
    axs[1].add_collection(LineCollection(bdry, linewidths=0.2, color='black', zorder=0))
